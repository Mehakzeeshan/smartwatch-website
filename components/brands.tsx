...
const Brands = () => {
  return (
    <section>
    <div className="brands  flex justify-evenly mx-16 mt-16 px-16 gap-5" id="brands"> 
      <div className='box1 flex-1 bg-[#F8F8F8] px-12 flex h-[230px] max-w-[380px] rounded-3xl items-center hover:bg-[#F8F8F8] '>
        <div>
      ...
      <div className='box2 flex-1 bg-[#F6F6F6] px-12 flex h-[230px] max-w-[380px] rounded-3xl items-center hover:bg-[#F8F8F8]'>
        <div>
      ...
      <div className='box3 flex-1 bg-[#F6F6F6] px-12 flex h-[230px] max-w-[380px] rounded-3xl items-center hover:bg-[#F8F8F8]'>
        <div>
